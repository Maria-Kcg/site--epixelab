...
function Header() {
    ...
    return (
        <header className="flex justify-between items-center max-w-[1100px] mx-8 lg:mx-auto my-10">
            <div>
            ...
            <NavigationMenu className="hidden lg:flex">
                <NavigationMenuList className="flex flex-col lg:flex-row">
                    <NavigationMenuItem>
                        <NavigationMenuLink asChild className="hover:bg-transparent hover:text-[#FF6600] focus:text-[#FF6600]">
                            <Link to="/home">Home</Link>
                        </NavigationMenuLink>
                    </NavigationMenuItem>
                    <NavigationMenuItem>
                        <NavigationMenuLink asChild className="hover:bg-transparent hover:text-[#FF6600]">
